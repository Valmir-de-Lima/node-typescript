...
export class ProductController {
    ...
    async getById(@Param('id') id) {
        try {
            ...
            return new Result(null, true, product, null);
        } catch (error) {
            throw new HttpException(new Result('Não foi possível retornar o produto', false, null, error), HttpStatus.BAD_REQUEST);
        }
    }
